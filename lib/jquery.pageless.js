...
// Modified 08/22/2011 by tehprofessor
// added setting (loadHidden) to load if element is visible
// it's set to false by default
// Useful for stopping calls on hidden content from .pageless
// EX:
// $('.element').pageless({loadHidden: false});
